 ...
 *
 * @package    mod
 * @subpackage learnanalytics
 * @copyright  NetSpot Pty Ltd
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['learnanalytics:addinstance'] = 'Add an learnanalytics instance'; // This should never appear. This mod is a container for sub-plugins.
...
learnanalytics data.  If this is set, risk calculations displayed in the
...
this fashion. Please contact your system administrator to set the mod_learnanalytics plugin as hidden.';
$string['modulename'] = 'Learning Analytics';
$string['modulenameplural'] = 'Learning Analytics';
...
$string['subplugintype_indicator'] = 'Learning Analytics Indicator';