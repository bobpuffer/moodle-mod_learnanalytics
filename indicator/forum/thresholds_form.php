...
class indicator_forum_thresholds_form {
    ...
    public function definition_inner(&$mform) {
        ...
        $strmaxrisk = get_string('maxrisk', 'indicator_forum');
        $strnorisk = get_string('norisk', 'indicator_forum');
        ...
        foreach ($elements as $element) {
            ...
            $mform->addGroup($grouparray, "group_forum_$element", get_string("e_$element", "indicator_forum"), '&nbsp;',
                false);
        }
    }
}
